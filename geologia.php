...
// Consulta SQL para obtener los registros de la tabla geologia
$sql = "SELECT idGeologia, tipo_rocas, descripcion, Pieza_idPieza FROM geologia"; 
$stmt = $pdo->query($sql);
...
<head>
    ...
    <title>Listado de Geología</title>
...
<div class="container mt-5">
    <h2 class="text-center mb-4">Listado de Geología</h2>
    ...
    <div class="table-responsive">
        <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $row['idGeologia']; ?></td>
                    <td><?php echo $row['tipo_rocas']; ?></td>
                    <td><?php echo $row['descripcion']; ?></td>
                    <td><?php echo $row['Pieza_idPieza']; ?></td>
                    <td>
                        <a href="ver.php?id=<?php echo $row['idGeologia']; ?>" class="btn btn-info btn-sm">Ver</a>
                        <a href="editar.php?id=<?php echo $row['Pieza_idPieza']; ?>&clasificacion=Geología" class="btn btn-warning btn-sm">Editar</a>
