...
// Consulta SQL para obtener los registros de la tabla osteologia
$sql = "SELECT idOsteologia, especie, clasificacion, Pieza_idPieza FROM osteologia"; 
$stmt = $pdo->query($sql);
...
<head>
    ...
    <title>Listado de Osteología</title>
...
<div class="container mt-5">
    <h2 class="text-center mb-4">Listado de Osteología</h2>
    ...
    <div class="table-responsive">
        <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $row['idOsteologia']; ?></td>
                    <td><?php echo $row['especie']; ?></td>
                    <td><?php echo $row['clasificacion']; ?></td>
                    <td><?php echo $row['Pieza_idPieza']; ?></td>
                    <td>
                        <a href="verOsteologia.php?id=<?php echo $row['idOsteologia']; ?>" class="btn btn-info btn-sm">Ver</a>
                        <a href="editar.php?id=<?php echo $row['Pieza_idPieza']; ?>&clasificacion=Osteología" class="btn btn-warning btn-sm">Editar</a>
