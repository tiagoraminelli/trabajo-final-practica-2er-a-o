...
// Consulta SQL para obtener los registros de la tabla paleontologia
$sql = "SELECT idPaleontologia, era, periodo, descripcion, Pieza_idPieza FROM paleontologia"; 
$stmt = $pdo->query($sql);
...
<head>
    ...
    <title>Listado de Paleontología</title>
...
<div class="container mt-5">
    <h2 class="text-center mb-4">Listado de Paleontología</h2>
    ...
    <div class="table-responsive">
        <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $row['idPaleontologia']; ?></td>
                    <td><?php echo $row['era']; ?></td>
                    <td><?php echo $row['periodo']; ?></td>
                    <td><?php echo $row['descripcion']; ?></td>
                    <td><?php echo $row['Pieza_idPieza']; ?></td>
                    <td>
                        <a href="verPaleontologia.php?id=<?php echo $row['idPaleontologia']; ?>" class="btn btn-info btn-sm">Ver</a>
                        <a href="editarPaleontologia.php?id=<?php echo $row['idPaleontologia']; ?>" class="btn btn-warning btn-sm">Editar</a>
