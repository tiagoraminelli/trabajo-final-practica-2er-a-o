...
// Consulta SQL para obtener los registros de la tabla arqueologia
$sql = "SELECT idArqueologia, integridad_historica, estetica, material, Pieza_idPieza FROM arqueologia"; 
$stmt = $pdo->query($sql);
...
<div class="container mt-5">
    <h2 class="text-center mb-4">Listado de Arqueología</h2>
    ...
    <div class="table-responsive">
        <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $row['idArqueologia']; ?></td>
                    <td><?php echo $row['integridad_historica']; ?></td>
                    <td><?php echo $row['estetica']; ?></td>
                    <td><?php echo $row['material']; ?></td>
                    <td><?php echo $row['Pieza_idPieza']; ?></td>
                    <td>
                        <a href="verArqueologia.php?id=<?php echo $row['idArqueologia']; ?>" class="btn btn-info btn-sm">Ver</a>
                        <a href="editarArqueologia.php?id=<?php echo $row['idArqueologia']; ?>" class="btn btn-warning btn-sm">Editar</a>
