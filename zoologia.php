...
// Consulta SQL para obtener los registros de la tabla zoologia
$sql = "SELECT idZoologia, reino, familia, especie, orden, phylum, clase, genero, descripcion, Pieza_idPieza FROM zoologia"; 
$stmt = $pdo->query($sql);
...
<div class="container mt-5">
    <h2 class="text-center mb-4">Listado de Zoología</h2>
    ...
    <div class="table-responsive">
        <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $row['idZoologia']; ?></td>
                    <td><?php echo $row['reino']; ?></td>
                    <td><?php echo $row['familia']; ?></td>
                    <td><?php echo $row['especie']; ?></td>
                    <td><?php echo $row['orden']; ?></td>
                    <td><?php echo $row['phylum']; ?></td>
                    <td><?php echo $row['clase']; ?></td>
                    <td><?php echo $row['genero']; ?></td>
                    <td><?php echo $row['Pieza_idPieza']; ?></td>
                    <td>
                        <a href="verZoologia.php?id=<?php echo $row['idZoologia']; ?>" class="btn btn-info btn-sm">Ver</a>
                        <a href="editar.php?id=<?php echo $row['Pieza_idPieza']; ?>&clasificacion=Zoología" class="btn btn-warning btn-sm">Editar</a>
