...
<div class="container mx-auto my-12 px-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 class="text-xl font-semibold text-primary-custom text-center mb-2">Personal</h3>
        ...
        <!-- Miembro 2 -->
        <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            <img class="w-32 h-32 rounded-full mx-auto mb-4" src="./assets/img/empleado.png" alt="Foto del miembro 2">
            <h3 class="text-xl font-semibold text-primary-custom text-center mb-2">Personal</h3>
        ...
        <!-- Miembro 3 -->
        <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            <img class="w-32 h-32 rounded-full mx-auto mb-4" src="./assets/img/empleada.png" alt="Foto del miembro 3">
            <h3 class="text-xl font-semibold text-primary-custom text-center mb-2">Personal</h3>
        ...
        <!-- Miembro 4 -->
        <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
            <img class="w-32 h-32 rounded-full mx-auto mb-4" src="./assets/img/empleado.png" alt="Foto del miembro 4">
            <h3 class="text-xl font-semibold text-primary-custom text-center mb-2">Personal</h3>
